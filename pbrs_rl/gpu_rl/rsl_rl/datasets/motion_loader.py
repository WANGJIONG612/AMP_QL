...
class AMPLoader:
    ...
    directory = '/home/zcy/project/AMP_for_hardware-main/datasets/mocap_motions/'  
    ...
    def __init__(
            ...
            # motion_files=glob.glob('/home/zcy/project/AMP_for_hardware-main/datasets/mocap_motions/*.txt'),
            motion_files = glob.glob(os.path.join(directory, '*.txt'))  
            ):
        ...
        # directory = '/home/zcy/project/AMP_for_hardware-main/datasets/mocap_motions/'  
        motion_files = glob.glob(os.path.join('/home/zcy/project/AMP_for_hardware-main/datasets/mocap_motions/', '*.txt'))  
        # print("1",motion_files)
        ...
        if self.preload_transitions:
            ...
            print(f'Finished preloading',num_preload_transitions)
